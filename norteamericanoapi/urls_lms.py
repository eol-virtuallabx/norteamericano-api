...
from .views import *
from .rest_api import EnrollApi, UnenrollApi, ReRunPendingCourseApi, ReRunApi, CourseStaffEnrollApi
...
urlpatterns = [
    ...
    url(r'^api/v0/course-staff/$', CourseStaffEnrollApi.as_view(), name='course-staff-api'),
